...
VERSION = "1.0.0"
SERVICE_NAME = "sm-procurement"
DISPLAY_NAME = "SM Procurement"
DESCRIPTION = "采购管理系统：供应商、采购申请、订单与验收"
...
class Item(BaseModel):
    ...
    owner: str = Field(default="采购部", min_length=1, max_length=80)
    priority: Literal["P0", "P1", "P2", "P3"] = "P1"
    status: Literal["planned", "active", "review", "closed"] = "active"

ITEMS: list[dict[str, object]] = [
    {"id": "demo-1", "name": "核心能力基线", "owner": "采购部", "priority": "P1", "status": "active", "created_at": datetime.now(UTC).isoformat()},
